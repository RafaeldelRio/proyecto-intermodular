...
# Primera exposición
- Cambiar roles a CEO, CTO y CMO
- Proyecto en github de tipo kanban
...
- IDE
	- https://antigravity.google/?hl=es-419
	- https://cursor.com/
...
- Obligatorio para aprobar
	- Https y dominio
		- dominio con my.noip.com
		- https://freedns.afraid.org/
	- Base de datos
- Github
	- Repo público
	- Creadas varias tags, como v1.0, v1.1, etc...
	- Readme debe estar bien
- Registro manda correo
- Validaciones en formularios
- No debe haber botones que no hagan nada
